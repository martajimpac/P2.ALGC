...
public class HeatMap {
     ...
     * the z-values.
     */
    public HeatMap(double[][] zValues, double low, double high) {
     ...
     * incorrect.
     */
    public void saveToFile(File outputFile, int[][] recorrido) throws IOException {
        ...
        if (ext.toLowerCase().equals("jpg") || ext.toLowerCase().equals("jpeg")) {
            BufferedImage chart = (BufferedImage) getChartImage(false,recorrido);

            // Save our graphic.
            saveGraphicJpeg(chart, outputFile, 1.0f);
        } else {
            BufferedImage chart = (BufferedImage) getChartImage(true,recorrido);
     ...
     */
    public Image getChartImage(boolean alpha,int [][] recorrido) {
        ...
        drawHeatMap(chartGraphics, zValues, recorrido);
     ...
     * onto a chart.
     */
    private void drawHeatMap(Graphics2D chartGraphics, double[][] data, int[][] recorrido) {
